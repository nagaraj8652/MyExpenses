...
public class In_view extends ListActivity {
	...
	public void addptr()
	{
		m_adapter = new ItemAdapter(In_view.this, R.layout.list_item, abc);
    ...
    { 
       case R.id.Today: 
    	   ...
    	   abc = mydb.gettodayincome();
    	   addptr();
    	   
           return true; 
           
       case R.id.Current_Week:
    	   abc = mydb.getweekincome();
    	   addptr();
    	   
    	   return true;
    	   
       case R.id.Current_Month:
    	   abc = mydb.getmonthincome();
           addptr();
